...
/**
 * 1: CacheManager是对{@link Cache}对象的管理类 , CacheManager主要服务于{@link CacheResolver}类。<br/>
 * 2: 检索Cache的解析器，Cache是Spring cache中的一个逻辑抽象，例如：Redis中逻辑的分块。在CacheResolver内部，底层实现使用的是CacheManager获取具体的Cache
 * <p>
